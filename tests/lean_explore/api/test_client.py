...
from lean_explore.api.client import Client, _DEFAULT_API_BASE_URL
...
class TestAPIClient:
    ...
    async def test_search_successful_no_filters(self, mocker: "MockerFixture"):
        ...
        mock_response_json: Dict[str, Any] = {
            ...
            "results": [
                {
                    "id": 1, "primary_declaration": {"lean_name": "Nat.add"},
                    "source_file": "Nat.lean", "range_start_line": 10,
                    "statement_text": "def Nat.add ...", "display_statement_text": "def Nat.add ...",
                    "docstring": "Adds two natural numbers.", "informal_description": "Function for addition."
                }
            ],
            "count": 1,
    ...
    async def test_search_successful_with_package_filters(self, mocker: "MockerFixture"):
        ...
        mock_response_json: Dict[str, Any] = {
            "query": query, "packages_applied": package_filters, "results": [],
            "count": 0, "total_candidates_considered": 0, "processing_time_ms": 50
        }
    ...
    async def test_search_request_error(self, mocker: "MockerFixture"):
        ...
        client = Client(api_key="test_key")
        mock_async_client_instance = MagicMock()
        mock_async_client_instance.get = AsyncMock(side_effect=httpx.RequestError("Connection failed", request=MagicMock()))
        mock_async_client_constructor = mocker.patch("httpx.AsyncClient")
        mock_async_client_constructor.return_value.__aenter__.return_value = mock_async_client_instance
    ...
    async def test_get_by_id_successful(self, mocker: "MockerFixture"):
        ...
        mock_response_json: Dict[str, Any] = {
            "id": group_id, "primary_declaration": {"lean_name": "Specific.Item"},
            "source_file": "Specific.lean", "range_start_line": 1,
            "statement_text": "def Specific.Item ...", "display_statement_text": "def Specific.Item ...",
            "docstring": "A specific item.", "informal_description": None
        }
        mock_http_response = MagicMock(spec=httpx.Response, status_code=200)
        mock_http_response.json.return_value = mock_response_json
        mock_http_response.raise_for_status = MagicMock()
        ...
        mock_async_client_instance.get.assert_awaited_once_with(
            f"{client.base_url}/statement_groups/{group_id}",
            headers=client._headers
        )
    ...
    async def test_get_dependencies_successful(self, mocker: "MockerFixture"):
        ...
        mock_response_json: Dict[str, Any] = {
            ...
            "citations": [
                {
                    "id": 789, "primary_declaration": {"lean_name": "Dependency.One"},
                    "source_file": "Dep.lean", "range_start_line": 1,
                    "statement_text": "def Dependency.One ...", "display_statement_text": None,
                    "docstring": None, "informal_description": None
                }
            ],
            "count": 1
        }
    ...
    async def test_get_dependencies_http_error_other_than_404(self, mocker: "MockerFixture"):
